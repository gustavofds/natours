...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZ3VzdGF2b2ZkcyIsImEiOiJja3BsZnl6Z2oxMml2MnFvZ3dxYXVhYmxzIn0.lYYYN4TbQMNk0X6_zst0VQ';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            // Same function is used to data update and password update
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51J0WfmGj8vqypO5QiJLKZVitj7RUmsKQQuYo1Jd48zPcAXhGyASYDWls861fdnwIFbs8wXtOeL20FDKwM5ADxVbi00NSCB0M9B'); // 1) Get checkout session from API
...
if (bookBtn) bookBtn.addEventListener('click', function (event) {
  ...
  var tourId = event.target.dataset.tourId; // data-tour-id
